...
export const featuredResources = [
  {
    ...
    description: "A complete step-by-step guide for aspiring physics olympians.",
...
export const guideCards = [
  ...
  {
    slug: "best-books-for-olympiads",
    title: "Best Books for Olympiads",
    category: "General",
    description: "Curated list of must-read books for Physics, Chemistry, Math, and more.",
    readTime: "15 min",
    level: "Beginner",
  },
  {
    slug: "how-training-camps-work",
  ...
  {
    slug: "long-problem-solving",
    title: "Long Problem Solving",
    category: "Physics",
    description: "Frameworks and techniques to tackle long, multi-step physics problems effectively.",
    readTime: "22 min",
    level: "Advanced",
  },
  {
    slug: "what-to-study-after-school-syllabus",
  ...
  {
    slug: "organic-reactions-roadmap",
