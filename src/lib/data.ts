...
export const tracks = [
  ...
  },
  {
    ...
    icon: "brain-circuit",
    color: "text-cyan-700",
    gradient: "from-cyan-500/12 to-emerald/10",
    summary: "Machine learning, data, computer vision, natural language processing, and responsible AI systems.",
    exam: "IOAI",
    officialUrl: "https://ioai-official.org/",
    pathwayVerifiedAt: "June 14, 2026",
    outcomes: ["Build and evaluate AI models", "Connect theory with practical implementation", "Prepare for Pakistan's IOAI selection"],
    topics: ["Machine learning", "Deep learning", "Computer vision", "Natural language processing", "AI ethics"],
    pathway: [
      { title: "National Selection", copy: "Enter Pakistan's accredited national selection rounds coordinated through Aitchison College.", icon: "clipboard" },
      { title: "Shortlisting", copy: "Top performers advance through the national assessment process.", icon: "list-checks" },
      { title: "Training", copy: "Selected students prepare across AI theory, implementation, and team tasks.", icon: "book" },
      { title: "Team Pakistan", copy: "The final delegation is selected to represent Pakistan.", icon: "flag" },
      { title: "IOAI", copy: "Compete at the International Olympiad in Artificial Intelligence.", icon: "brain-circuit" },
    ],
  },
  {
    ...
    gradient: "from-amber-400/14 to-teal/10",
    summary: "Atomic structure, radiation, nuclear reactions, safety, applications, and experimental problem solving.",
    exam: "INSO",
    officialUrl: "https://inso.mawhiba.sa/en/",
    pathwayVerifiedAt: "June 14, 2026",
    outcomes: ["Reason about nuclear phenomena", "Apply radiation safety principles", "Prepare for Pakistan's INSO selection"],
    topics: ["Atomic and nuclear structure", "Radiation", "Fission and fusion", "Nuclear applications", "Risk and safety"],
    pathway: [
      { title: "National Selection", copy: "Apply through Pakistan's PAEC-supported national selection process.", icon: "clipboard" },
      { title: "Assessment", copy: "Candidates are evaluated for scientific understanding and problem solving.", icon: "list-checks" },
      { title: "PIEAS Preparation", copy: "Selected students train with nuclear science specialists, including PIEAS faculty.", icon: "graduation-cap" },
      { title: "Team Pakistan", copy: "The final delegation is prepared to represent Pakistan internationally.", icon: "flag" },
      { title: "INSO", copy: "Compete at the International Nuclear Science Olympiad.", icon: "radiation" },
    ],
  },
];
